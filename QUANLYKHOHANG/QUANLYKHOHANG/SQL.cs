...
namespace QUANLYKHOHANG
{
    public class SQL
    {
        private static string _cnn = @"Data Source=DESKTOP-85V5Q0S\\VANHIEU;Initial Catalog=QUANLYKHOHANG;User ID=sa;Password=123";
       ...
       /// <returns></returns>
        ...
        public bool ThemPhieu(string mapn,DateTime ngaynh,string sl,string tongtien,string manv)
        {
            try
            {
        ...
        public bool ThemPhieuX(string mapx,DateTime ngayxh,string tongsoluong,string tongtien,string makh,string manv)
        {
            try
            {
        ...
        public bool SuaPhieuN(string mapn, DateTime ngaynh, string sl, string tongtien, string manv)
        {
            try
            {
        ...
        public bool SuaPhieuX(string mapx, DateTime ngayxh, string tongsoluong, string tongtien, string makh, string manv)
        {
            try
            {
